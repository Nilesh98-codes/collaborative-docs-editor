    ...
    <div className={`flex ${isUser ? "justify-end" : "justify-start"} mb-3`}>
      ...
      >
        {isUser ? (
          ...
          <div className="max-w-none text-[13px] leading-relaxed [&_p]:mb-1.5 [&_p:last-child]:mb-0 [&_ul]:list-disc [&_ul]:pl-4 [&_ul]:mt-0.5 [&_ul]:mb-1.5 [&_ul:last-child]:mb-0 [&_ol]:list-decimal [&_ol]:pl-4 [&_ol]:mt-0.5 [&_ol]:mb-1.5 [&_ol:last-child]:mb-0 [&_li]:mb-px [&_li]:leading-snug [&_h1]:text-base [&_h1]:font-bold [&_h1]:mb-1 [&_h1]:mt-1.5 [&_h2]:text-sm [&_h2]:font-bold [&_h2]:mb-1 [&_h2]:mt-1 [&_h3]:text-[13px] [&_h3]:font-semibold [&_h3]:mb-0.5 [&_h3]:mt-1 [&_code]:bg-neutral-200/70 [&_code]:px-1 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-xs [&_code]:font-mono [&_pre]:bg-neutral-200/70 [&_pre]:p-2 [&_pre]:rounded-lg [&_pre]:mb-1.5 [&_pre]:overflow-x-auto [&_blockquote]:border-l-2 [&_blockquote]:border-neutral-300 [&_blockquote]:pl-3 [&_blockquote]:italic [&_blockquote]:text-neutral-600 [&_strong]:font-semibold [&_a]:text-indigo-600 [&_a]:underline">
